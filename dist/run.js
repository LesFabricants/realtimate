...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!uri) {
        console.warn("Using memory mongo server, if you want to use another mongo server, add MONGODB_URI as an env variable in your .env file");
        const mongod = yield mongodb_memory_server_1.MongoMemoryServer.create();
        ["SIGINT", "SIGTERM", "SIGQUIT"].forEach((signal) => process.on(signal, () => __awaiter(void 0, void 0, void 0, function* () {
            console.log("Stopping memory server");
            yield mongod.stop({ doCleanup: true });
            process.exit(0);
        })));
        // await mongod.start();
        uri = mongod.getUri();
